...
- You may mix item_ids, card_descriptions, and new_items in the same sale
- sale.item_ids OR sale.card_descriptions OR sale.new_items (or any combination) is sufficient — do NOT add any of them to missing[] if at least one is present
...
- Required: expense.amount; sale.item_ids (if no I-#### given AND no card_descriptions AND no new_items); purchase.card_cost
